        ...
        try:
            ...
            point = models.PointStruct(
                ...
                payload={
                    ...
                    "resource_created_at": chunk.resource.created_at.isoformat()
                    if chunk.resource.created_at
                    else None,
                },
            )
...
def downgrade() -> None:
    ...
    print("Downgrade not needed - this migration only adds missing data")
    pass
